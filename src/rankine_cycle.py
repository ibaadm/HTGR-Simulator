...
class RankineCycle:
    def __init__(self, config_dict):
        ...
        self.boiler_pressure_mpa = steam_params.get('boiler_pressure_mpa', 10.0)
        self.pinch_point_delta_t = steam_params.get('pinch_point_delta_t', 30.0)
        self.condenser_temp_c = steam_params.get('condenser_temp_c', 50.0)
        
        self.turbine_efficiency = (config_dict.get('efficiencies', {})
                                  .get('turbine', 0.85))
