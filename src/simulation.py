...
class PlantModel:
    ...
    def __init__(self, config_path: str = "config") -> None:
        ...
        self.fan_penalty = self.sim_cfg.get("heat_rejection", {}).get(
    ...
    def _load_yaml(self, filename: str) -> dict:
        ...
        try:
            ...
            print(
                f"WARNING: Config file {filename} not found. Using defaults."
            )
            return {}
    ...
    def save_results(self):
        ...
        print(
            f"Total Energy Generated: {self.total_energy_produced_mwh:.2f} MWh"
        )
