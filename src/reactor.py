...
class HTGRCore:
    ...
    def __init__(self, config_dict):
        ...
        self.pump_time_constant = thermo.get('pump_time_constant_seconds', 300.0)
        ...
        self.nominal_mass_flow = power_watts / (self.helium_cp * delta_t_design)
    ...
    def get_thermal_stats(self, time):
        ...
        if self.current_mass_flow < 0.1:
            ...
            delta_t = current_power_watts / (self.current_mass_flow * self.helium_cp)
